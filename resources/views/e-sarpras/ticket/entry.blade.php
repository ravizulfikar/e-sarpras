...
@section('title', $pages['entry']['title'] ?? '-' )
						...
						@foreach($data as $ticket)
							<tr>
								...
								<td class="va-middle">
									...
									{{-- <a href="{{ route($pages['entry']['update'], $ticket) }}" class="btn btn-outline-success btn-xs"> Process</a> --}}
