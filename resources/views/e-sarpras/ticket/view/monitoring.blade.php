		...
		<div class="card shadow mb-3 bg-white rounded">
			...
			<div class="card-body">
				...
				<div class="row">
					...
					<div class="col-md-3 DivNE" style="font-size:7pt !important;">
						<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-md-3 DivTV" style="font-size:7pt !important;">
						<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-md-3 DivAD" style="font-size:7pt !important;">
						<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-md-3 DivAV" style="font-size:7pt !important;">
						<div class="form-group">
							<label for="">Banyaknya Komputer yang terinstal</label>
...
<div class="row m-t-10 mb-3" style="font-size:9pt;">
	<div class="col-sm-12">
		<div class="form-group">
