...
<li class="breadcrumb-item"><a href="{{ route($pages['admin']['url']) }}">{{ $pages['admin']['title'] ?? '-' }}</a></li>
<li class="breadcrumb-item active">{{ $pages['admin']['view']['title'] ?? '-' }}</li>
@endsection
		...
		<div class="col-xl-12 box-col-6">
			<div class="card card-absolute">
				...
				<div class="card-body">
					...
					<div class="row mb-3">
						<div class="col-sm-12">
							<a href="{{ route($pages['admin']['url']) }}" class="btn btn-warning">Back</a>
						</div>
					</div>
				</div>
			</div>
