            ...
            <div class="col-xl-5 col-lg-6">
              <div class="content">
                <div>
                  ...
                  <div class="btn-grp mt-4"><a class="btn btn-pill btn-primary btn-air-primary btn-lg me-3 wow pulse" href="index.html" target="_blank"> <img src="{{ asset('assets/images/landing/icon/html/html.png') }}" alt="">HTML</a><a class="btn btn-pill btn-secondary btn-air-secondary btn-lg me-3 wow pulse" href="https://react.pixelstrap.com/cuba/dashboard/default/Dubai" target="_blank"><img src="{{ asset('assets/images/landing/icon/react/react.png') }}" alt="">React</a><a class="btn btn-pill btn-info btn-air-info btn-lg wow pulse" href="http://angular.pixelstrap.com/cuba/" target="_blank"> <img src="{{ asset('assets/images/landing/icon/angular/angular.svg') }}" alt="">Angular</a></div>
                  <div class="btn-grp mt-4"><a class="btn btn-pill btn-secondary btn-air-secondary btn-lg wow pulse me-3" href="https://vue.pixelstrap.com/cuba/dashboard/default" target="_blank"> <img src="{{ asset('assets/images/landing/icon/vue/vue.png') }}" alt="">VueJs</a><a class="btn btn-pill btn-success btn-air-success btn-lg wow pulse me-3" href="http://laravel.pixelstrap.com/cuba/pages/landing" target="_blank"> <img src="{{ asset('assets/images/landing/icon/laravel/laravel2.png') }}" alt="">Laravel</a></div>
                </div>
              </div>
            </div>
          ...
          <div class="row demo-imgs">
            <div class="col-lg-4 col-md-6 wow pulse demo-content">
              <div class="cuba-demo-img">
                <div class="overflow-hidden"><img class="img-fluid" src="{{ asset('assets/images/landing/layout-images/dubai.jpg') }}" alt="default"></div>
            ...
            <div class="col-lg-4 col-md-6 wow pulse demo-content">
              <div class="cuba-demo-img">
                <div class="overflow-hidden"><img class="img-fluid" src="{{ asset('assets/images/landing/layout-images/los.jpg') }}" alt="material"></div>
            ...
            <div class="col-lg-4 col-md-6 wow pulse demo-content">
              <div class="cuba-demo-img">
                <div class="overflow-hidden"><img class="img-fluid" src="{{ asset('assets/images/landing/layout-images/paris.jpg') }}" alt="classicSidebar"></div>
            ...
            <div class="col-lg-4 col-md-6 wow pulse demo-content">
              <div class="cuba-demo-img">
                <div class="overflow-hidden"><img class="img-fluid" src="{{ asset('assets/images/landing/layout-images/tokyo.jpg') }}" alt="compact"></div>
            ...
            <div class="col-lg-4 col-md-6 wow pulse demo-content">
              <div class="cuba-demo-img">
                <div class="overflow-hidden"><img class="img-fluid" src="{{ asset('assets/images/landing/layout-images/moscow.jpg') }}" alt="collapse"></div>
            ...
            <div class="col-lg-4 col-md-6 wow pulse demo-content">
              <div class="cuba-demo-img">
                <div class="overflow-hidden"><img class="img-fluid" src="{{ asset('assets/images/landing/layout-images/singapore.jpg') }}" alt="enterprise"></div>
            ...
            <div class="col-lg-4 col-md-6 wow pulse demo-content">
              <div class="cuba-demo-img">
                <div class="overflow-hidden"> <img class="img-fluid" src="{{ asset('assets/images/landing/layout-images/newyork.jpg') }}" alt="centralize"></div>
            ...
            <div class="col-lg-4 col-md-6 wow pulse demo-content">
              <div class="cuba-demo-img">
                <div class="overflow-hidden"><img class="img-fluid" src="{{ asset('assets/images/landing/layout-images/barc.jpg') }}" alt="further"></div>
            ...
            <div class="col-lg-4 col-md-6 wow pulse demo-content">
              <div class="cuba-demo-img">
                <div class="overflow-hidden"><img class="img-fluid" src="{{ asset('assets/images/landing/layout-images/madrid.jpg') }}" alt="revolutionary"></div>
            ...
            <div class="col-lg-4 col-md-6 wow pulse demo-content">
              <div class="cuba-demo-img">
                <div class="overflow-hidden"><img class="img-fluid" src="{{ asset('assets/images/landing/layout-images/romo.jpg') }}" alt="statistics"></div>
            ...
            <div class="col-lg-4 col-md-6 wow pulse demo-content">
              <div class="cuba-demo-img">
                <div class="overflow-hidden"><img class="img-fluid" src="{{ asset('assets/images/landing/layout-images/seoul.jpg') }}" alt="trendy"></div>
            ...
            <div class="col-lg-4 col-md-6 wow pulse demo-content">
              <div class="cuba-demo-img">
                <div class="overflow-hidden"><img class="img-fluid" src="{{ asset('assets/images/landing/layout-images/london.jpg') }}" alt="blank"></div>
          ...
          <div class="row">                 
            ...
            <div class="col-sm-12 framworks">                 
              <ul class="nav nav-pills justify-content-center" id="pills-tab" role="tablist">
                ...
                <li class="nav-item"><a class="d-flex nav-link" id="pills-vue-tab" data-bs-toggle="pill" href="#pills-vue" role="tab" aria-controls="pills-vue" aria-selected="false"> <img src="{{ asset('assets/images/landing/icon/vue/vue.png') }}" alt="">
                    <div class="text-start">
          ...
          <div class="landing-slider">
            <div class="row">
              <div class="col-xl-3 col-lg-4 col-sm-6 mb-4">
                <div class="img-effect mb-3"><a href="../theme/social-app.html" target="_blank"><img class="img-fluid cuba-img" src="{{ asset('assets/images/landing/social-app.jpg') }}" alt=""></a></div>
                <h4>Social App</h4>
              </div>
              <div class="col-xl-3 col-lg-4 col-sm-6 mb-4"> 
                <div class="img-effect mb-3"><a href="../theme/knowledgebase.html" target="_blank"><img class="img-fluid cuba-img" src="{{ asset('assets/images/landing/knowlagebase-app.jpg') }}" alt=""></a></div>
                <h4>knowledgebase</h4>
              </div>
              <div class="col-xl-3 col-lg-4 col-sm-6 mb-4"> 
                <div class="img-effect mb-3"><a href="../theme/support-ticket.html" target="_blank"><img class="img-fluid cuba-img" src="{{ asset('assets/images/landing/support-ticket-app.jpg') }}" alt=""></a></div>
                <h4>Support Ticket</h4>
              </div>
              <div class="col-xl-3 col-lg-4 col-sm-6 mb-4">
                <div class="img-effect mb-3"><a href="../theme/email-application.html" target="_blank"><img class="img-fluid cuba-img" src="{{ asset('assets/images/landing/mail-app.jpg') }}" alt=""></a></div>
                <h4>Email Dashboard</h4>
              </div>
              <div class="col-xl-3 col-lg-4 col-sm-6 mb-4">
                <div class="img-effect mb-3"><a href="../theme/to-do.html" target="_blank"><img class="img-fluid cuba-img" src="{{ asset('assets/images/landing/To-Do-app.jpg') }}" alt=""></a></div>
                <h4>To-Do</h4>
              </div>
              <div class="col-xl-3 col-lg-4 col-sm-6 mb-4">
                <div class="img-effect mb-3"><a href="../theme/job-cards-view.html" target="_blank"><img class="img-fluid cuba-img" src="{{ asset('assets/images/landing/job-search-app.jpg') }}" alt=""></a></div>
                <h4>Job Search</h4>
              </div>
              <div class="col-xl-3 col-lg-4 col-sm-6 mb-4">
                <div class="img-effect mb-3"><a href="../theme/product-page.html" target="_blank"><img class="img-fluid cuba-img" src="{{ asset('assets/images/landing/ecommerce-app.jpg') }}" alt=""></a></div>
                <h4>Ecommerce</h4>
              </div>
              <div class="col-xl-3 col-lg-4 col-sm-6 mb-4">                             
                <div class="img-effect mb-3"><a href="../theme/kanban.html" target="_blank"><img class="img-fluid cuba-img" src="{{ asset('assets/images/landing/apps/kanban.jpg') }}" alt=""></a></div>
                <h4>Kanban</h4>
              </div>
              <div class="col-xl-3 col-lg-4 col-sm-6 mb-4">
                <div class="img-effect mb-3"><a href="../theme/file-manager.html" target="_blank"><img class="img-fluid cuba-img" src="{{ asset('assets/images/landing/apps/file.jpg') }}" alt=""></a></div>
                <h4>File Manager</h4>
              </div>
              <div class="col-xl-3 col-lg-4 col-sm-6 mb-4">         
                <div class="img-effect mb-3"><a href="../theme/projects.html" target="_blank"><img class="img-fluid cuba-img" src="{{ asset('assets/images/landing/apps/project.jpg') }}" alt=""></a></div>
                <h4>Project</h4>
              </div>
              <div class="col-xl-3 col-lg-4 col-sm-6 mb-4">
                <div class="img-effect mb-3"><a href="../theme/contacts.html" target="_blank"><img class="img-fluid cuba-img" src="{{ asset('assets/images/landing/apps/contacts.jpg') }}" alt=""></a></div>
                <h4>Contacts</h4>
              </div>
              <div class="col-xl-3 col-lg-4 col-sm-6 mb-4">
                <div class="img-effect mb-3"><a href="../theme/chat.html" target="_blank"><img class="img-fluid cuba-img" src="{{ asset('assets/images/landing/apps/chat.jpg') }}" alt=""></a></div>
                <h4>Chat</h4>
              </div>
            </div>
          </div>
      ...
      <section class="section-space cuba-demo-section app_bg">
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-8 wow pulse"><a href="index.html"><img class="img-fluid email-img" src="{{ asset('assets/images/landing/email_section_img.png') }}" alt=""></a></div>
          </div>
        </div>
      </section>
